      ...
      <div className="container mx-auto px-4 lg:px-10">
        <div className="inner flex justify-between items-center w-full h-[70px] lg:h-[80px]">
          ...
          <div className="flex items-center gap-3">
            <button className="hidden sm:block bg-[#3b82f6] text-white px-5 lg:px-7 py-2.5 lg:py-3 rounded-full font-bold shadow-[0_10px_20px_rgba(59,130,246,0.3)] hover:bg-blue-600 transition-all duration-300 text-[13px] lg:text-[14.5px] whitespace-nowrap">
              Free Trial Class
            </button>
            <button
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white border-t border-slate-100 shadow-lg">
          <nav className="container mx-auto px-4 py-4 flex flex-col gap-1">
            ...
            <button className="mt-3 bg-[#3b82f6] text-white px-7 py-3 rounded-full font-bold shadow-[0_10px_20px_rgba(59,130,246,0.3)] hover:bg-blue-600 transition-all duration-300 text-[14.5px]">
              Free Trial Class
            </button>
          </nav>
        </div>
